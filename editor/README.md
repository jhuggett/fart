# fastart classic -- the raylib editor

> The original editor, Odin + raylib. The repo's front door is the
> top-level README; the studio (`studio/`) is where the editor is headed.
> Build scripts live at the repo root: `./build.sh`, `./build_web.sh`,
> `./build_app.sh`.
